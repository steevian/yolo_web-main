...
export const dynamicRoutes: Array<RouteRecordRaw> = [
	{
		...
		children: [
			...
			},
			{
				path: '/train',
				name: 'trainManage',
				component: () => import('@/components/layout/routerView/parent.vue'),
				...
				children: [
					{
						path: '/train/model',
						name: 'trainModel',
						component: () => import('@/views/Train/ModelTrain/index.vue'),
						meta: {
							title: '模型训练',
							isLink: '',
							isHide: false,
					...
					},
					{
						path: '/train/monitor',
						name: 'trainMonitor',
						component: () => import('@/views/Train/TrainMonitor/index.vue'),
						meta: {
							title: '训练监控',
							isLink: '',
							isHide: false,
					...
					{
						path: '/train/dataset',
						name: 'trainDatasetAnalysis',
						component: () => import('@/views/Train/DatasetAnalysis/index.vue'),
						meta: {
							title: '数据集分析',
							isLink: '',
							isHide: false,
					...
					{
						path: '/train/compare',
						name: 'trainModelCompare',
						component: () => import('@/views/Train/ModelCompare/index.vue'),
						meta: {
							title: '模型比较',
							isLink: '',
							isHide: false,
...
export const staticRoutes: Array<RouteRecordRaw> = [
	...
	// 修复1：注册页组件路径修正为实际存在的 login/register.vue（非独立register目录）
	{
		path: '/register',
		name: 'register',
	...
	// 修复2：视频查看页路径修正为实际存在的 videoRecord/show.vue（非独立videoShow目录）
	{
		path: '/videoShow',
		name: 'videoShow',
