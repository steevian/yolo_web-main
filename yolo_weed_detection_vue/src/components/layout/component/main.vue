...
// 引入组件
const LayoutParentView = defineAsyncComponent(() => import('@/components/layout/routerView/parent.vue'));
const LayoutFooter = defineAsyncComponent(() => import('@/components/layout/footer/index.vue'));
