...
import { useKeepALiveNames } from '@/utils/stores/keepAliveNames';
...
// 引入组件
const Contextmenu = defineAsyncComponent(() => import('@/components/layout/navBars/tagsView/contextmenu.vue'));
