...
## 项目特点
- 支持图片和视频的杂草检测与结果展示
- 前端采用Vue3 + Vite，界面美观，交互友好。我觉得很有意思的一个部分是我的前端登录页面，借鉴了一些其他GitHub项目和我在流媒体上看到的创意，如果你有兴趣可以先查看我的根目录下的Login.html。
...
详细使用说明和开发日志文档请见 docs/ 目录（后续会补充详细使用说明，现在可能只有一些日志文档）。
